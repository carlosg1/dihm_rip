                    ...
                    <div role="navigation" class="navbar navbar-inverse top-navbar top-navbar-right">
                        ...
                        <nav class="collapse collapsing navbar-collapse" style="width: auto;">
                            <ul class="nav navbar-nav navbar-right">
                                <li class="hidden-xs">
                                    <a title="Ir al inicio" href="https://www.formosa.gob.ar">
                                        <span class="hidden-sm hidden-md hidden-lg">Inicio</span>
                                        <i class="fa fa-home after"></i>
                                    </a>
                                </li>
                                <li class="hidden-xs">
                                    <a title="Mapa del sitio" href="https://www.formosa.gob.ar/mapadelsitio">
                                ...
                                <li>
                                    <a href="https://www.formosa.gob.ar/miportal" ><i class="fa fa-unlock after"></i> Mi Portal</a>
                                </li>
                                <li>
